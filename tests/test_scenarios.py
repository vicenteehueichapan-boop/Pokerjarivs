...
class TestPokerBrain(unittest.TestCase):
    ...
    def test_preflop_weak_hand_fold(self):
        ...
        villain = Villain(position="SB", status="ACTIVE", stack=1000, current_investment=1000, name="Villain1")
    ...
    def test_integration_json(self):
        # Test the full input/output dict flow including Name for DB
        input_data = {
          "game_id": "test_1",
          "street": "RIVER",
          "pot_size": 100.0,
          ...
          "villains": [
            {
              ...
              "stack": 950.0,
              "current_investment": 0.0,
              "name": "ManiacMike", # Test if Main parses this correctly
              "stats": {}
            }
          ]
        }
